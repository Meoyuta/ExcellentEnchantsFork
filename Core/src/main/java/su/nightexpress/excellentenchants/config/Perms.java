...
public class Perms {
    ...
    public static final UniPermission COMMAND_QUERY      = new UniPermission(PREFIX_COMMAND + "query");
    public static final UniPermission COMMAND_UNYIELDING = new UniPermission(PREFIX_COMMAND + "unyielding");
